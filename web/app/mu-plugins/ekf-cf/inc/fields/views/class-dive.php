  ...
  public static function create() {
	...
	$builder
      ...
      ->addAccordion("Social Post")
		...
		->addTab("Links")
					->addText("Specialist Text", ['default_value' => "Simple for our specialists"])
					->addPostObject('Specialist Links', ['post_type' => "highlight", 'return_format' => 'id','multiple' => 1])
					->addText("Customer Text", ['default_value' => "Simple for your customers"])
					->addPostObject('Customer Links', ['post_type' => "highlight", 'return_format' => 'id','multiple' => 1])
