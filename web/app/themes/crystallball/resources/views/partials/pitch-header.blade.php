...
<header class="banner pitch-header w-full absolute z-100 flex justify-between items-start" data-module="header">
  <div class="w-32 inline-blockmd:w-40 h-12 m-4 md:m-6 lg:m-8">@include('partials.image-element', ['image' => $logo, 'args' =>[ 'max_width' => 450]])</div>
  <button data-mobile-menu-toggle class="relative z-100 w-12 h-12 lg:w-16 lg:h-16 text-xl lg:text-2xl flex items-center justify-center bg-lightblue text-white text-xl"><i data-open aria-label="Open Menu" class="inline-block icon-menu"></i> <i data-close aria-label="Open Menu" class="inline-block icon-times" aria-hidden="true"></i></button>
</header>
