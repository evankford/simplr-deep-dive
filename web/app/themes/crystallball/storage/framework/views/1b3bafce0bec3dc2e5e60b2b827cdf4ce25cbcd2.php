...
<text transform="matrix(0.5 -0.866 0.866 0.5 18.762 421.28)" class="gst2 gst3 gst4"><?php echo e($strings[0]); ?></text>
<text transform="matrix(0.5 -0.866 0.866 0.5 62.4734 421.28)" class="gst2 gst3 gst4"><?php echo e($strings[1]); ?></text>
<text transform="matrix(0.5 -0.866 0.866 0.5 106.1851 421.28)" class="gst2 gst3 gst4"><?php echo e($strings[2]); ?></text>
<text transform="matrix(0.5 -0.866 0.866 0.5 149.896 421.28)" class="gst2 gst3 gst4"><?php echo e($strings[3]); ?></text>
<text transform="matrix(0.5 -0.866 0.866 0.5 193.6072 421.28)" class="gst2 gst3 gst4"><?php echo e($strings[4]); ?></text>
<text transform="matrix(0.5 -0.866 0.866 0.5 237.3186 421.28)" class="gst2 gst3 gst4"><?php echo e($strings[5]); ?></text>
<text transform="matrix(0.5 -0.866 0.866 0.5 281.0303 421.28)" class="gst2 gst3 gst4"><?php echo e($strings[6]); ?></text>
<text transform="matrix(0.5 -0.866 0.866 0.5 324.7415 421.28)" class="gst2 gst3 gst4"><?php echo e($strings[7]); ?></text>
<text transform="matrix(0.5 -0.866 0.866 0.5 368.4532 421.28)" class="gst2 gst3 gst4"><?php echo e($strings[8]); ?></text>
<text transform="matrix(0.4776 -0.9734 0.8271 0.562 412.1628 428.0006)" class="gst2 gst3 gst5"><?php echo e($strings[9]); ?></text>
<text transform="matrix(0.4776 -0.9734 0.8271 0.562 459.875 428.0006)" class="gst2 gst3 gst5"><?php echo e($strings[10]); ?></text>
<text transform="matrix(0.4776 -0.9734 0.8271 0.562 507.5873 428.0006)" class="gst2 gst3 gst5"><?php echo e($strings[11]); ?></text>
...
</div><?php /**PATH /Users/evan/Local Sites/crystall-ball/app/bedrock/web/app/themes/crystallball/resources/views/partials/single-graph.blade.php ENDPATH**/ ?>