...
/* harmony import */ var _thehonestscoop_findandreplacedomtext__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @thehonestscoop/findandreplacedomtext */ "./node_modules/@thehonestscoop/findandreplacedomtext/src/findAndReplaceDOMText.js");
/* harmony import */ var _thehonestscoop_findandreplacedomtext__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_thehonestscoop_findandreplacedomtext__WEBPACK_IMPORTED_MODULE_5__);
/**
...
function findAndReplaceText() {
  replacers.forEach(function (replacer) {
    _thehonestscoop_findandreplacedomtext__WEBPACK_IMPORTED_MODULE_5___default()(document.body, replacer);
  });
}
...
var Animator = /*#__PURE__*/function () {
  function Animator(el) {
    ...
    this.el = el;
    this.controller = new scrollmagic__WEBPACK_IMPORTED_MODULE_2__["Controller"]();
    this.init(); // ScrollMagicPluginGsap(ScrollMagic, TweenMax, TimelineMax);
  }
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Animator, [{
    ...
    value: function basics() {
      ...
      $(this.el).find('[data-anim-in]').each(function (childI, el) {
        var mainTl = new gsap__WEBPACK_IMPORTED_MODULE_3__["TimelineMax"]();
        ...
        new scrollmagic__WEBPACK_IMPORTED_MODULE_2__["Scene"]({
          ...
          triggerHook: 0.85,
          reverse: false
        }).setTween(mainTl).addTo(_this.controller);
      });
      $(this.el).find('[data-anim-in-children]').each(function (childI, el) {
        var childTl = new gsap__WEBPACK_IMPORTED_MODULE_3__["TimelineMax"]();
        var delay = childI * .2000;
        ...
        new scrollmagic__WEBPACK_IMPORTED_MODULE_2__["Scene"]({
          ...
          triggerHook: 0.95,
          reverse: false
        }).setTween(childTl).addTo(_this.controller);
      });
    }
  }]);
...
/***/ "./resources/assets/scripts/components/site-section.js":
/*!*************************************************************!*\
  !*** ./resources/assets/scripts/components/site-section.js ***!
  \*************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _gsapUtilities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gsapUtilities */ "./resources/assets/scripts/components/gsapUtilities.js");
...
var Section = /*#__PURE__*/function () {
  function Section(el) {
    ...
    this.active = false;
    this.animator = new _gsapUtilities__WEBPACK_IMPORTED_MODULE_2__["default"](el);
    this.isAhead = this.setAhead.bind(this);
    this.isBehind = this.setBehind.bind(this);
    this.isOff = this.setOff.bind(this);
    this.isCurrent = this.setCurrent.bind(this); // this.isNext = this.setNext.bind(this);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Section, [{
    ...
    value: function checkScrollStatus() {
    ...
    value: function setCurrent() {
      ...
      if (!this.el.classList.contains('section-active')) {
        this.el.classList.add('section-active'); // setTimeout(()=>{
    ...
    value: function setOff() {
      this.el.classList.remove('section-active'); // setTimeout(()=>{
      //   this.el.classList.remove('incoming')}, 1000)
      // this.el.setAttribute('data-position', 'current')
      // this.animator.stop();
    }
    ...
    key: "progressStep",
    value: function progressStep() {}
  }, {
    key: "regressStep",
    value: function regressStep() {}
  }]);
...
var Goodbyes = /*#__PURE__*/function () {
  function Goodbyes(el) {
    ...
    this.percentString = this.number * 18 + '%'; // this.init();
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Goodbyes, [{
    key: "init",
    value: function init() {
      var maxY = -100 + 100 / this.number + '%';
      console.log(this.parent);
      new scrollmagic__WEBPACK_IMPORTED_MODULE_2__["Scene"]({
        duration: this.percentString,
        triggerElement: this.el.parentNode.parentNode,
        triggerHook: "onLeave"
      }).addTo(this.controller).setTween(this.list, 0.2, {
        y: maxY,
...
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_site_section__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/site-section */ "./resources/assets/scripts/components/site-section.js");
/* harmony import */ var query_string__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! query-string */ "./node_modules/query-string/index.js");
/* harmony import */ var query_string__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(query_string__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _components_DrawSVGPlugin__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/DrawSVGPlugin */ "./resources/assets/scripts/components/DrawSVGPlugin.js");
...
gsap__WEBPACK_IMPORTED_MODULE_5__["gsap"].registerPlugin(_components_DrawSVGPlugin__WEBPACK_IMPORTED_MODULE_6__["DrawSVGPlugin"]); // var activeEvent = new Event('slideActive');
...
var Slider = /*#__PURE__*/function () {
  function Slider(el) {
    ...
    Object(scrollmagic_plugin_gsap__WEBPACK_IMPORTED_MODULE_7__["ScrollMagicPluginGsap"])(scrollmagic__WEBPACK_IMPORTED_MODULE_4__, gsap__WEBPACK_IMPORTED_MODULE_5__["TweenMax"], gsap__WEBPACK_IMPORTED_MODULE_5__["TimelineMax"]);
    this.el = el;
    this.sections = [];
    this.currentIndex = -1;
    ...
    this.controller = new scrollmagic__WEBPACK_IMPORTED_MODULE_4__["Controller"]({});
    this.init();
  }
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Slider, [{
    ...
    value: function setupSections() {
      ...
      sectionList.forEach(function (sectionEl) {
        var sectionClass = new _components_site_section__WEBPACK_IMPORTED_MODULE_2__["default"](sectionEl);

        _this.sections.push(sectionClass);
      });
      this.max = this.sections.length - 1;
      this.setupSectionScrollers();
    }
  }, {
    key: "setupSectionScrollers",
    value: function setupSectionScrollers() {
      var _this2 = this;

      var self = this;
      this.sections.forEach(function (section) {
        var transformerTL = new gsap__WEBPACK_IMPORTED_MODULE_5__["TimelineMax"]();
        transformerTL.fromTo(section.el, {
          "--transformer": '-50px'
        }, {
          "--transformer": '50px',
          duration: 1
        });
        var pinner = new scrollmagic__WEBPACK_IMPORTED_MODULE_4__["Scene"]({
          triggerElement: section.el,
          triggerHook: 0,
          duration: "100%"
        }).setTween(transformerTL).addTo(_this2.controller);
        var list = section.el.querySelector('.goodbye-list');

        if (list) {
          transformerTL.to(list, 3, {
            y: '-78.5%'
          });
    ...
    key: "startSingleGraph",
    value: function startSingleGraph() {
      var graph = this.el.querySelector('.single-graph');
      var gtl = new gsap__WEBPACK_IMPORTED_MODULE_5__["TimelineMax"]({
        repeat: 0
      });
      var bars = graph.querySelectorAll('.gst1'); // gtl.from('.graph-graph', 0.5, {opacity: 0}, 0)
      ...
      gtl.staggerFrom('.gst5', 0.2, {
        opacity: 0,
        ease: gsap__WEBPACK_IMPORTED_MODULE_5__["Power2"].easeInOut
      }, 0.05, 1.25); // gtl.staggerFrom('.gst3', 0.2, { autoAlpha: 0, ease: Power2.easeInOut}, 0.05, 1.25);
    ...
    value: function start() {
      ...
      var hash = query_string__WEBPACK_IMPORTED_MODULE_3___default.a.parse(location.hash);
      var foundIndex = this.sections.findIndex(function (section) {
    ...
    value: function setInitialSlide() {
      ...
      this.currentSection.isCurrent(); // this.changeSlide()
    }
  }, {
    key: "setupListeners",
    value: function setupListeners() {
      ...
      var self = this;
      this.observer = new IntersectionObserver(this.checkActive, {
        threshold: 0.5
      });
      this.sections.forEach(function (section) {
        _this3.observer.observe(section.el);
      });
    }
  }, {
    key: "checkActiveSections",
    value: function checkActiveSections(entries, observer) {
      var _this4 = this;

      entries.forEach(function (entry) {
        var index = entry.target.getAttribute('data-index');
        var obj = _this4.sections[index];
    ...
    key: "doTrio",
    value: function doTrio() {
      var trio = this.el.querySelector('.single-graph');
      var gtl = new gsap__WEBPACK_IMPORTED_MODULE_5__["TimelineMax"]({
        repeat: 0
      });
      var bars = trio.querySelectorAll('.gst1');
      gtl.from('.graph-graph', 0.5, {
        opacity: 0
      }, 0);
      var barTime = 0.5;
...
__webpack_require__(/*! /Users/evan/Local Sites/crystall-ball/app/bedrock/web/app/themes/crystallball/resources/assets/scripts/app.js */"./resources/assets/scripts/app.js");
__webpack_require__(/*! /Users/evan/Local Sites/crystall-ball/app/bedrock/web/app/themes/crystallball/resources/assets/styles/app.scss */"./resources/assets/styles/app.scss");
module.exports = __webpack_require__(/*! /Users/evan/Local Sites/crystall-ball/app/bedrock/web/app/themes/crystallball/resources/assets/styles/editor.scss */"./resources/assets/styles/editor.scss");
