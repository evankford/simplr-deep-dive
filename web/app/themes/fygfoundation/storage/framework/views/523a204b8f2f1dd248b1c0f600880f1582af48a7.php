<div class="flex flex-wrap items-stretch justify-center m-2 text-black bg-white md:flex-nowrap shadow-fun flex-full lg:flex-some">
  ...
  <div class="p-8 pb-4 flex-300">
    <h3 class="mb-2 text-3xl font-black uppercase md:text-4xl"><?php echo e(get_the_title()); ?></h3>
...
</div><?php /**PATH /Users/evan/Local Sites/fygfoundation/app/bedrock/web/app/themes/fygfoundation/resources/views/partials/partnership-excerpt.blade.php ENDPATH**/ ?>