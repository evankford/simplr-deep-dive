...
Object(scrollmagic_plugin_gsap__WEBPACK_IMPORTED_MODULE_8__["ScrollMagicPluginGsap"])(ScrollMagic__WEBPACK_IMPORTED_MODULE_7__, gsap__WEBPACK_IMPORTED_MODULE_5__["TweenMax"], gsap__WEBPACK_IMPORTED_MODULE_5__["TimelineMax"]);
object_fit_images__WEBPACK_IMPORTED_MODULE_10___default()();
gsap__WEBPACK_IMPORTED_MODULE_5__["gsap"].registerPlugin(_components_DrawSVGPlugin__WEBPACK_IMPORTED_MODULE_6__["DrawSVGPlugin"]);
var plugins = [gsap__WEBPACK_IMPORTED_MODULE_5__["CSSPlugin"], _components_DrawSVGPlugin__WEBPACK_IMPORTED_MODULE_6__["DrawSVGPlugin"]]; // if (!plugins) {
...
var SiteScroller = /*#__PURE__*/function () {
  function SiteScroller() {
    ...
    this.controller = new ScrollMagic__WEBPACK_IMPORTED_MODULE_7__["Controller"]();
    this.init();
  }
    ...
    value: function init() {
      ...
      $('section, footer, header').each(function (i, parent) {
        $(parent).find('[data-anim-in]').each(function (childI, el) {
          var mainTl = new gsap__WEBPACK_IMPORTED_MODULE_5__["TimelineMax"]();
        ...
        $(parent).find('[data-anim-in-children]').each(function (childI, el) {
          var childTl = new gsap__WEBPACK_IMPORTED_MODULE_5__["TimelineMax"]();
          var delay = childI * .2000;
        ...
        $(parent).find('[data-anim-in-issue]').each(function (childI, el) {
          var childTl = new gsap__WEBPACK_IMPORTED_MODULE_5__["TimelineMax"]();
          var delay = childI * 0.2;
          childTl.from($(el).find('path'), {
            duration: 1.15,
            drawSVG: 0
          }, 0.75).delay(delay);
          childTl.from($(el).find('.flex-300:first-child'), 1, {
            autoAlpha: 0,
            y: 20,
            ease: gsap__WEBPACK_IMPORTED_MODULE_5__["Power2"].easeInOut
          }, 0).delay(delay);
          childTl.from($(el).find('.flex-300:last-child'), 1, {
            autoAlpha: 0,
            y: 20,
            ease: gsap__WEBPACK_IMPORTED_MODULE_5__["Power2"].easeInOut
          }, 1.5).delay(delay);
...
var map = {
	...
	"./count-me": "./resources/assets/scripts/modules/count-me.js",
	"./count-me.js": "./resources/assets/scripts/modules/count-me.js",
...
/***/ "./resources/assets/scripts/modules/count-me.js":
/*!******************************************************!*\
  !*** ./resources/assets/scripts/modules/count-me.js ***!
  \******************************************************/
/*! exports provided: default */
...
var CountMe = /*#__PURE__*/function () {
  function CountMe(el) {
    ...
    this.countUp = new countup_js__WEBPACK_IMPORTED_MODULE_2__["CountUp"](this.el, this.number);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(CountMe, [{
    key: "runIt",
    value: function runIt(observed) {
      var _this = this;
...
var Header = /*#__PURE__*/function () {
  function Header(el) {
    ...
    this.imageHeader = jquery__WEBPACK_IMPORTED_MODULE_2___default()(" main .image-header-full:first-child");
    this.gradientHeader = jquery__WEBPACK_IMPORTED_MODULE_2___default()('main [data-module="animate-gradient"]:first-child');
