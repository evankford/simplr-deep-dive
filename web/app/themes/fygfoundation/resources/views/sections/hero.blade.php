<section class="relative flex flex-wrap items-center justify-center w-full overflow-hidden section-hero max-w-screen bg-blacker min-h-90h lg:flex-no-wrap">
  ...
  @if ($main_title)
    <h1 data-anim-in class="relative z-20 flex-auto max-w-full p-6 m-4 mt-20 text-5xl font-bold leading-none tracking-wider text-center uppercase main-title lg:text-huge flex-some">{{$main_title}}</h1>
  @endif
