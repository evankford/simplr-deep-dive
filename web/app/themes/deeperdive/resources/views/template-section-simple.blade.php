...
<section id="{{$id}}" data-page="{{get_the_id()}}"   data-position="ahead" data-index="{{$index}}"  class="section-wrap @if ($full_height) md:min-h-screen md:p-12 @endif   p-8  bg-style--{{$bg_style}}">
  <style>
    section#{{$id}} {
