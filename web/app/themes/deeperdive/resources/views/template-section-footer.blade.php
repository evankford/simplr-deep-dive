...
<section id="{{$id}}" data-title="{{$title}}"   data-position="ahead" data-index="{{$index}}"  class="section-wrap @if ($full_height) md:min-h-screen @endif   pt-24 px-16 sm:px-24 bg-style--{{$bg_style}}">
  <style>
    section#{{$id}} {
