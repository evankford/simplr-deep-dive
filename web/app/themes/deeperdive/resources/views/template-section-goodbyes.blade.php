...
<section id="{{$id}}" data-page="{{get_the_id()}}"   data-anim-steps="graph" data-position="ahead" data-index="{{$index}}"  class="section-wrap @if ($full_height) md:min-h-screen @endif  bg-style--{{$bg_style}}">
  <style>
    section#{{$id}} {
